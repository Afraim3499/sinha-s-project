          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-24 items-center">
            ...
            <MotionSection delay={0.2} className="space-y-12">
              ...
              <div className="space-y-6 text-foreground/70 leading-relaxed text-lg font-light">
                <p>
                  Our journey began long before Sinha Sourcing Hub Ltd was officially formed. Growing up in Bangladesh, we were surrounded by a family deeply involved in trade and craftsmanship. Our ancestors and parents were active in the Jute/Golden Fiber trading industry from the British era until 1982, laying a foundational heritage of knowledge in textiles, fabrics, raw materials, and business management. This legacy shaped our early passion for apparel, accessories, and the art of trade.
                </p>
                <p>
                  The spark of fashion and design truly ignited during our school days. What started as creative experimentation—modifying waistbands and customizing school uniforms—quickly turned into our very first entrepreneurial venture: recreating the iconic <strong className="font-semibold text-stone-900">TinTin character</strong> on custom-made T-shirts. We designed, produced, and sold these T-shirts directly to our classmates, marking our earliest lessons in merchandising, customer demand, and product execution. That hands-on schoolboy curiosity laid the groundwork for our future in the professional space.
                </p>
                <p>
                  By 1998, this early fascination evolved into a serious, professional journey. In the decades that followed, our founders and partners gained deep, hands-on experience in our respective fields. Rather than limiting ourselves to one vertical, we built decades of multi-disciplinary expertise across <strong className="font-semibold text-stone-900">Garments and Apparel</strong>, <strong className="font-semibold text-stone-900">Global Shipping and Logistics</strong>, <strong className="font-semibold text-stone-900">Information Technology (IT)</strong>, and <strong className="font-semibold text-stone-900">Finance & Accounts</strong>. This unique combination of backgrounds is what sets us apart: we understand not only how a garment is stitched, but also how it is financed, how the technical infrastructure supports it, and how it is shipped across global borders efficiently.
                </p>
                <p>
                  We had envisioned uniting this collective, multi-industry expertise to launch our sourcing hub years earlier. However, when the COVID-19 pandemic disrupted the global supply chain, we chose to delay our official launch, prioritizing direct support for our existing industry partners and navigating the crisis alongside them. This period of resilience only strengthened our foundation. In 2023, we officially established Sinha Sourcing Hub Ltd, bringing together decades of cross-functional wisdom to provide global brands with <Link href="/process" className="text-foreground hover:text-accent font-medium underline decoration-border/50 underline-offset-4 transition-colors">reliable, transparent sourcing solutions</Link> built to withstand any challenge.
                </p>
              </div>
            </MotionSection>
          </div>
