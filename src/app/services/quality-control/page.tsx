...
export const metadata: Metadata = {
  ...
  alternates: { canonical: "/services/quality-control" },
  openGraph: {
    title: "Quality Control & Compliance | Sinha Sourcing Hub Ltd",
    description: "Prevent delays and defects with pre-production quality checks, inline inspection coordination, and compliance verification.",
    url: "https://sinhasourcinghub.com/services/quality-control",
    images: [{ url: "/service-qc.png", width: 1200, height: 630, alt: "Quality Control" }],
  },
}
...
export default function QualityControlPage() {
  const breadcrumbSchema = {
    ...
    "itemListElement": [
      ...
      { "@type": "ListItem", "position": 3, "name": "Quality Control", "item": "https://sinhasourcinghub.com/services/quality-control" }
    ]
  }
